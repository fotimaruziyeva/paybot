...
const items = [
	<div className='relative w-full sm:h-[650px] h-72 overflow-hidden'>
		<img
			...
			alt='PUBG'
			className='w-full min-h-full aspect-video object-cover rounded-lg'
...
const Home = () => {
	return (
		<div className='w-full h-full bg-[#272727] text-white flex flex-col items-center px-3'>
			...
			<div className=' w-full   flex flex-col items-center bg-[#3D3D3D] sm:px-10 sm:py-8 p-5 space-y-8 rounded-lg'>
				{/* Search Input */}
