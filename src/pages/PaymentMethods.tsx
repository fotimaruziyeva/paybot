...
const PaymentMethods = () => {
  return (
    <div className="w-full  mx-auto bg-gray-900 text-white min-h-screen">
      ...
      <div className="w-full p-8 bg-gray-800 rounded-2xl mx-auto shadow-lg">
        <h1 className="text-3xl font-bold  text-yellow-400">Payment Methods</h1>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
          {payment.map((card) => (
            <div
              className="bg-gray-700 rounded-lg shadow-lg p-6 text-center hover:scale-105 transition-all duration-300"
              key={card.id}
            >
      ...
      <div className="p-8 mt-8 rounded-2xl bg-gray-800 shadow-lg mx-auto">
      ...
      <div className="flex items-center justify-center mt-8">
        <Button className="max-xl  p-10 bg-gradient-to-r from-yellow-400 to-pink-500 text-white rounded-lg shadow-xl hover:bg-pink-600">
